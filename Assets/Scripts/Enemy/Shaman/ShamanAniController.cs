...
public class ShamanAniController : MonoBehaviour
{
    [SerializeField]
    ...
    void Shoot()
    {
        ...
        currentProjectile.GetComponent<Rigidbody>().AddForce(projectileVector.normalized * projectilespeed, ForceMode.Impulse);
    }
